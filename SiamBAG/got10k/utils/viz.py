...
def show_frame(image, boxes=None, num_frames=None, frame_idx=None, fig_n=1, fig_name=None, pause=0.001,
    ...
    if num_frames is not None and frame_idx is not None:
        FPS_txt = 'Frame: ' + str(frame_idx)+'/' + str(num_frames)
        txt = plt.text(10, 15, FPS_txt, weight="bold", color="r", fontsize=16)

        # txt = plt.text(10, 15, FPS_txt, clip_on=False, color="r", fontsize=10, weight="bold",
